document.addEventListener('DOMContentLoaded', () => {
    ...
    let highlight = 1; //在游戏结束但未重开时即使点击也无高亮效果
    let answer = 0; //检测是否点击显示答案，若是，不展示胜利弹窗
    ...
    function checkGameCompletion() {
        ...
        clearInterval(timer);
        timer = null;
        if (answer == 0) showResultModal(true);
        else showAnswerComplete();
        return true;
    }
